...
sudo xbps-install -S 7zip element-desktop firefox fish-shell flameshot git github-cli gparted htop krita lightdm-gtk-greeter-settings mpv pass qView sakura vscode unzip xtools
```